...
#define USE_CDC_TERMINAL 1 // enable ASCII mode on CDC loop (not used by BOSSA); 228 bytes
...
#else
#define COLOR_START 0x002020
#define COLOR_USB 0x400000
...
#define PINVAL(pin)    (PORT->Group[(pin) / 32].PINVAL.reg & (1 << ((pin) % 32)))
